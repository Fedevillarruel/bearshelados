...
const defaultAppUserAgent = "BearsHeladosCapacitacion (federico@fedini.app)";
...
export function getTiendanubeConfig(): TiendanubeConfig {
  ...
  const appUserAgent = process.env.TIENDANUBE_APP_USER_AGENT?.trim() || defaultAppUserAgent;
