...
export default async function AdminCoursesPage() {
	...
	const [{ data: courseData }, { data: moduleData }, { data: enrollmentData }] = await Promise.all([
		supabase.from("courses").select("id, title, slug, description, summary, cover_url, cover_storage_path, category, estimated_minutes, is_published, order_index").order("order_index"),
